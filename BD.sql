...
INSERT INTO Evento(IdEvento,Titulo,Texto,Fecha,Imagen) VALUES (1,"La Noche de las Telecomunicaciones se celebrará este viernes en Guadalajara","Esta se complementará con cinco conferencias durante la mañana del viernes abiertas a toda la ciudadanía, que tendrán lugar en el salón de actos de la Delegación de la Junta de 11.00 a 13.00 horas.",'2019-11-29 11:00:00', "Evento1");
INSERT INTO Evento(IdEvento,Titulo,Texto,Fecha,Imagen) VALUES (2,"Cybersecurity Days, Aprende a Cuidar tu Información","El Poli, se complace en invitar a la comunidad en general a la Segunda Edición de los CyberSecurity Days Poli organizados por la Facultad de Ingeniería, Diseño e Innovación y la Gerencia de Tecnologías de la Información y Comunicaciones. El evento se desarrollará los días 18 y 19 de noviembre, dentro de las actividades se ofrecerán conferencias, sensibilizaciones y la competencia Capture The Flag (CTF CSD Poli 2019).",'2019-11-18 18:30:00', "Evento2");

INSERT INTO FotoGaleria(IdFotoGaleria,Imagen,Descripcion) VALUES (1,"FotoGaleria1","Satélite de comunicaciones Tiba-1 de Egipto.");
INSERT INTO FotoGaleria(IdFotoGaleria,Imagen,Descripcion) VALUES (2,"FotoGaleria2","Imagen promocional Cybersecurity Days POLI.");
